<?php
/* Smarty version 3.1.30, created on 2019-01-10 17:24:32
  from "E:\WWW\happygo\templates\index.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5c370f50cabf03_08824752',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'cb356240a094057524e24b4a5966a6d6bcd9d7f0' => 
    array (
      0 => 'E:\\WWW\\happygo\\templates\\index.html',
      1 => 1547112263,
      2 => 'file',
    ),
  ),
...
function content_5c370f50cabf03_08824752 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="full_nav">
        <div class="wr">
            <ul class="mhl_nav clearfix">
                ...
                <li><a href="tvshow.php">TV直播</a></li>
                <li><a href="javascript:void(0)">厨房必备</a></li>
                <li><a href="javascript:void(0)">美妆个护</a></li>
                <li><a href="javascript:void(0)">食品健康</a></li>
                <li><a href="javascript:void(0)">服装家纺</a></li>
                <li><a href="javascript:void(0)">日用家电</a></li>
            </ul>
        </div>
    </div>
    <!-- nav导航结束 -->
        ...
        <div class="r_s_f_center">
            <div class="f_c_top">
                        ...
                        <div class="rnuc_info_box">
                            <form action="" method="post">
                                ...
                                <div class="rnuc_uname rnuc_item">
                                    <input type="text" class="itxt nameIpt" placeholder="已验证手机/邮箱或用户名" name="username">
                                    <div class="rnuc_err_box">
                                        <div class="rnuc_err_msg">登录名可能是您的手机号、邮箱或用户名</div>
                                    </div>
                                </div>
                                <div class="rnuc_pwd rnuc_item">
                                    <input type="text" class="itxt pwdIpt" placeholder="请输入密码" name="userpwd">
                                    <div class="rnuc_err_box">
                                        <div class="rnuc_err_msg">您的密码可能为字母、数字或符号的组合</div>
                                    </div>
                                </div>
                                <div class="rnuc_yzm  rnuc_code">
                                    <input type="text" class="itxt codeIpt" id="Txtidcode" val="" placeholder="请输入验证码">
                                    <span id="idcode" class="yzm_pic clearcompatility">
                ...
                <div class="f_c_t_list">
                    <a href="javascript:;" class="cart_iflogin">
                ...
                <div class="f_c_t_list">
                    <a href="javascript:;" class="collect_iflogin">
        ...
        <div class="index_type">
            <ul class="index_type_ul clearfix">
                <li class="li_has_down">
                    <a href="classify.html" class="type_color">
